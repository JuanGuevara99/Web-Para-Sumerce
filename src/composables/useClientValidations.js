...
export const setCookie = ({ cookieItemName, value }) => {
  Cookies.set(cookieItemName, value);
};


export const getCookie = (cookieItemName) =>  {
  return Cookies.get(cookieItemName);
}

export const deleteCookie = ( cookieItemName) =>{
  Cookies.remove(cookieItemName);
}
